    ...
    >
        ...
        <h2 className="text-4xl md:text-5xl font-bold inline-block relative">
          ...
          <span className="block w-24 h-1 bg-gradient-to-r from-primary to-purple-500 mx-auto mt-4 rounded-full"></span>
            <p className="text-gray-400 max-w-2xl mx-auto mt-4 text-lg">
              A collection of my data-driven projects, exploring analytics, AI, and ML
            </p>
        </h2>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {projects.slice(0, 3).map((project) => (
          <div key={project.id} className="hover:-translate-y-2 transition-transform duration-300">
      ...
      <div className="flex justify-center mt-10">
        <Link
          ...
          className="px-6 py-3 rounded-lg font-medium transition
             ...
             hover:opacity-90 shadow-lg shadow-blue-500/30"
